...
2. Copy `public_ready/` into the `maxim-ultra/proof` GitHub Pages repository only after exact owner approval.
3. Wait for GitHub Pages to build.
4. Live-check each public URL before referencing it in any public close message.
